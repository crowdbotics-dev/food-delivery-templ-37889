...
## Project Structure
    ...
    ├── food_delivery_templ_37889  # Django project configurations
...
1. Clone this repo and `cd food_delivery_templ_37889`
...
2. Clone this repo and `cd food_delivery_templ_37889`
